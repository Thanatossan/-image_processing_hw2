...
filename1 = "./output_img/output1_6_spectrum.pgm"
filename2 = "./output_img/output1_6_phase.pgm"
col = 0
row = 0
converted_img = []
mattrix_img = []
...
for i in range(len(mattrix_img)):
    for j in range(len(mattrix_img[i])):
        ...
        mattrix_img[i][j] = checkfft(value)

wirefile = "output1_6_lenna_spectrum.pgm"
...
for i in range(len(mattrix_img2)):
    for j in range(len(mattrix_img2[i])):
        ...
        # fourier_transform[i][j] = int(check(value))
        mattrix_img2[i][j] = checkfft2(value)

wirefile2 = "output1_6_lenna_phase.pgm"
